...
class XmlFullOrdinate(list):
    ...
    def __init__(self, node, definition):
        """
        Get full ordinate and full borders Contours or EntitySpatial :parma definition  this CadastralNumber  or Definition ot NumberRecoed
